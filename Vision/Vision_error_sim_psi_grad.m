...
function [psi_error] = Vision_error_sim_psi_grad(angle_to_gate,distance_to_gate,gate_pos,pixel_noise,angle_noise)
%use NEU convention
...
[pos_a, phi_est, theta_est, psi_est] = angle_from_pos_grad_2(gate_pos,[cam_pos],sim_points_x-x_princip,sim_points_y-y_princip,-angles(1),-angles(2),0+psi_disturbance);
